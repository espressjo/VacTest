...
esp_32_serial_read::esp_32_serial_read()
{
     idport=0;
     fd=0;
     status=0;
}
int esp_32_serial_read::ouvrirport(int port,int vitesse) /* port = "0", "1" ou "2" , Vallee fev. 2012 */

{

  std::string fichier="/dev/ttyUSB"+std::to_string(port);
...
int esp_32_serial_read::configport()
{
...
============================================================================*/
int esp_32_serial_read::fermerport()
{
  if (close(fd)== NOK)
  {
...
/*==========================================================================
    ...
    revisions: 	Martin Riopel 22/08/2002
============================================================================*/
int esp_32_serial_read::ecrireport(std::string str)
{
  int ncar;
...
/*==========================================================================
    ...
    revisions: 	Martin Riopel 22/08/2002
============================================================================*/
int esp_32_serial_read::lireport (std::string *str,int ncar)
{
  int i,n=0;
  *str = "";
...
/*==========================================================================
    ...
    revisions: 	Martin Riopel 22/08/2002
============================================================================*/
void esp_32_serial_read::delay(int ms)
/*!
  *\brief Delay in ms
...
int esp_32_serial_read::lirec(char c)
{
  std::string str;
  int i=0;
  do
...
std::string esp_32_serial_read::conversion(std::string ss)
{
 std::string buff="";
  for (auto &c:ss)
  {
